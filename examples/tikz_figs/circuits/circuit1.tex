...
\begin{document}
   \begin{tikzpicture}
      ...
      \draw (x1.output) -| ([xshift = -\shift]x5.input 2) --++(\shift,0);
      ...
      % Insert labels
      \node[above] at ($(x3.output) + (\shift,0)$) (l1) {\gatetext$a \land b$};
      \node[above] at ($(x2.output) + (\shift,0)$) (l2) {\gatetext$a \land c$};
      \node[above] at ($(x1.output) + (\shift,0)$) (l3) {\gatetext$a \lor b$};
      \node[above] at ($(x4.output) + (2*\shift,0)$) (l4) {\gatetext$(a \land b)\lor (a\land c)$};
      \node[above] at ($(x5.output) + (4*\shift,0)$) (l5) {\gatetext$((a \land b)\lor (a\land c))\land(a\lor b)$};
