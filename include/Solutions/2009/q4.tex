...
Thus, substituting this into \req{2009:q4:PoisEqn1}, we get that,
\begin{align}
	 P(X \geq 1) & = 1 - P(X=0) \nn \\
	             & = 1 - e^{-2} \nn \\
	             & = 0.865 \,.  
...
From \rdef{mod2:defn:Poisson}, we see that,
\begin{equation}
...
Using \req{2009:q4:PoisEqn3}, we can find the following,
\begin{align}
