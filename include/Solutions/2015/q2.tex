...
From \rtab{2015:q2:tab:TrthTab} and using \rdef{mod1:defn:Tautology}, we can see that the expression, $\boldsymbol{(p \land q) \implies p}$, is a \textbf{tautology} as its truth value is alwauys 1. \\
...
Using the Distributive (\rdef{mod1:law:Distributive}), Annulment (\rdef{mod1:law:Annulment}) and Absorptive (\rdef{mod1:law:Absorptive}) laws on $P$, we see that,
\begin{align}
