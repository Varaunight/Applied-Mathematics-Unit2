...
Newton's Second Law states that, the rate of change of momentum of an object is directly proportional to the Resultant Force which acts on the object. We can represent this mathematically as,
\begin{align}
	\sum \vec{F} & \propto \ddd{p}{t} \nn \\
...
From our given information, we know that when $s_y=0$, $y=u$, and when $s_y=y_{\text{max}}$, $y=0$. Using these as our bounds of integration, we get that,
\begin{align}
...
\begin{align}
	\sum\vec{F}\xhat & = 0\xhat \nn \\
	\text{and} \nn \\
	\sum\vec{F}\yhat & = 0\yhat \,.
\end{align}
