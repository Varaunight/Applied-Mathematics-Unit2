...
We are asked to calculate the corresponding expected frequencies using a Binomial Distribution. Let $X$ be the discrete random variable that represents ``the number of 3's thrown when a dice is rolled 4 times.'' From \rdef{mod2:defn:Binomial}, we get,
\begin{equation}
...
Thus, we can give our expected frequencies in \rtab{2008M:q3:Bin1}.
...
From \rtab{2008M:q3:ChiTab}, we can see that our number of degrees of freedom, $\nu$, is,
\begin{equation}
	\nu = 3 - 1 = 2 \,.
\end{equation}
