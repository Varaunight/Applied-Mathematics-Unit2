...
From \rtab{2008M:q2:tab:HungAlgo}, the possible pairings of the runners and the parts of the race are,
\begin{align}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=0.75]{../2007/figures/2008M-ActNet1}
...
Using the float times from \rtab{2008M:q2:tab:ActNet2}, we can identify the critical path as the path that has zero float time (\rdef{mod1:defn:CritPath}).
\begin{equation}
...
The latest finish time of $E$ can be calucalated by the sum of the latest start time of $E$ and the duration of $E$. Therefore, from \rtab{2008M:q2:tab:ActNet2}, the latest finish time of $E$ is $22 + 12 = 34$.
