...
\textbf{\textit{Sketch and Translate:}} \\ \\
\TODO{We take the origin to be the reference point, and therefore (s(t=0))=0}As the particle passes the origin at $t=0$, we know that $s(t=0) = 0m$.
...
\textbf{\textit{Represent Mathematically:}} \\ \\
By \TODO{mention that v=ds/dt} the Fundamental Theorem of Calculus, we get that,
\begin{equation}
...
\textbf{\textit{Sketch and Translate:}} \\ \\
As we are given that the resisitive force, $F_R$, experienced by the body is directly proportional to the velocity, $v$, we can express this force in terms of a constant of proportionality $k$ in the form of $F_R=-kv.$\TODO{Justify the minus sign} We also get that the initial velocity, $v(t=0)=0$.
...
\textbf{\textit{Represent Mathematically:}} \\ \\
From Newton's Second Law, we get that, \TODO{Minus sign of F-R}
\begin{equation}
...
Switching variables, we get that, \TODO{Talk about v' amnd t' being arbitrary and so, we can swith.}
\begin{equation}
