...
From \rdef{mod2:defn:ContinuousRV:CDF}, we can relate the probability density function, $f$, ro the cumulative distribution function, $F$, via,
\begin{equation}
	f(x) = \ddd{}{x}F(x) \,.
\end{equation}
...
\begin{align}
	...
	0, & x \geq 6 
		\end{cases}
\end{align}
\TODO{Determine the right inequalities to put here. Also fix the wording to differentiat in the different regions.}
