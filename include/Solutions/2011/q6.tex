...
\textbf{\textit{Simplify and Diagram:}} \\ \\ \TODO{Add a new graph with displacement infromation and add u=0 into sketch and translate.}
...
Under our assumption that there is no net resultant force (and by extension, no net acceleration), we can consider Newton's Second Law in the $x$ direction as, \TODO{Instead put ma and not 0}
\begin{equation}
