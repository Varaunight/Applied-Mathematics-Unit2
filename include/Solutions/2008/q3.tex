...
We are given that $A$ and $B$ are independent. From \rdef{mod2:defn:Independent}, we get that,
\begin{equation}
...
From \rdef{mod2:defn:MutuallyExclusive}, we know that $A$ and $B$ are mutually exclusive iff,
\begin{equation}
	P(A \land B) = 0 \,.
\end{equation}
